...
class Ui_sgdDockWidgetBase(object):
    def setupUi(self, sgdDockWidgetBase):
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 493, 703))
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(":/plugins/swissgeodownloader/resources/question.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.guiQuestionBtn.setIcon(icon3)
