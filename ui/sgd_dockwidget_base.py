...
class Ui_sgdDockWidgetBase(object):
    def setupUi(self, sgdDockWidgetBase):
        ...
        self.guiDatasetList.setMinimumSize(QtCore.QSize(0, 0))
        self.guiDatasetList.setMaximumSize(QtCore.QSize(16777215, 100))
        self.guiDatasetList.setSizeAdjustPolicy(QtWidgets.QAbstractScrollArea.AdjustIgnored)
        ...
        self.horizontalLayout_5.addWidget(self.guiFileListStatus)
